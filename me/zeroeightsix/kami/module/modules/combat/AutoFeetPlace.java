...
public class AutoFeetPlace extends Module {
   ...
   private Setting<Boolean> spoofRotations = this.register(Settings.b("Spoof Rotations", true));
   private Setting<Boolean> spoofHotbar = this.register(Settings.b("Spoof Hotbar", false));
   private Setting<Double> blockPerTick = this.register(Settings.d("Blocks per Tick", 4.0D));

...
public class Holefill extends Module {
   private final Vec3d[] HolefillList = new Vec3d[]{new Vec3d(0.0D, 1.0D, 0.0D), new Vec3d(1.0D, 1.0D, 0.0D), new Vec3d(0.0D, 1.0D, 1.0D), new Vec3d(1.0D, 1.0D, 1.0D), new Vec3d(-1.0D, 1.0D, -1.0D), new Vec3d(1.0D, 1.0D, -1.0D), new Vec3d(-1.0D, 1.0D, 1.0D), new Vec3d(-1.0D, 1.0D, 0.0D), new Vec3d(0.0D, 1.0D, -1.0D), new Vec3d(0.0D, 1.0D, 2.0D), new Vec3d(0.0D, 1.0D, -2.0D), new Vec3d(2.0D, 1.0D, 0.0D), new Vec3d(-2.0D, 1.0D, 0.0D), new Vec3d(-2.0D, 1.0D, -2.0D), new Vec3d(2.0D, 1.0D, 2.0D), new Vec3d(-2.0D, 1.0D, 2.0D), new Vec3d(2.0D, 1.0D, -2.0D), new Vec3d(-1.0D, 1.0D, 2.0D), new Vec3d(-2.0D, 1.0D, 1.0D), new Vec3d(1.0D, 1.0D, -2.0D), new Vec3d(1.0D, 1.0D, 2.0D), new Vec3d(2.0D, 1.0D, -1.0D), new Vec3d(-1.0D, 1.0D, -2.0D), new Vec3d(-2.0D, 1.0D, -1.0D), new Vec3d(2.0D, 1.0D, 1.0D)};
   private final List obsidian;
   private Setting toggleable;
   private Setting slowmode;
   private Setting full;
   private Vec3d[] HolefillTargets;
      ...
      if (!this.isDisabled() && mc.field_71439_g != null && !ModuleManager.isModuleEnabled("Freecam")) {
         if (this.slowModeSwitch) {
            ...
            for(int i = 0; i < this.blocksPerTick; ++i) {
               if (this.offsetStep >= this.HolefillTargets.length) {
                  this.end();
                  return;
               }

               Vec3d offset = this.HolefillTargets[this.offsetStep];
      ...
      if (Wrapper.getWorld().func_180495_p(blockPos).func_185904_a().func_76222_j()) {
         ...
         if (newSlot == -1) {
            if (!(Boolean)this.toggleable.getValue()) {
               Command.sendChatMessage("Holefill: Please Put Obsidian in Hotbar");
            }
   ...
   private void init() {
      ...
      if (!(Boolean)this.full.getValue()) {
         this.HolefillTargets = this.HolefillList;
      }
